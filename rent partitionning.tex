...
\todo[inline]{découpage barycentrique vite fait}
...
Pour r\'esoudre ce probl\`eme, on fait un découpage barycentrique des diff\'erentes partitions possibles (dis\'etis\'ees) de la r\'epartition du loyer. On nomme les sommets %abandon de ma part... je n'ai pas tout compris!
\todo[inline]{parler de dualite?}
\todo[inline]{faire une fonction de payement theorie des jeux? ou pseudo fonction?, fait!}
